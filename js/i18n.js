const I18N = {
    ...
    dict: {
        zh: {
            ...
            'order.success.msg': '感谢您提交的详细信息。我们将尽快处理您的订单。',
            'order.success.ok': '确定',
            'order.agent.unavailable': '暂无可用的代理，请稍后再试。',
            'order.selectProduct': '请先选择产品',
            'order.fillRequired': '请填写必填字段',
            // 新增咨询相关翻译
            'order.enquiry.title': '📝 产品咨询',
            'order.enquiry.thanks': '感谢您的咨询！我们的代理会尽快联系您。',
            'order.enquiry.name': '👤 您的姓名 *',
            'order.enquiry.name.placeholder': '请输入您的姓名',
            'order.enquiry.phone': '📱 WhatsApp 手机号码 *',
            'order.enquiry.phone.placeholder': '例如: 0123456789',
            'order.enquiry.productType': '📦 产品类型 *',
            'order.enquiry.product': '🔧 具体产品 *',
            'order.enquiry.selectProductType': '请选择产品类型',
            'order.enquiry.selectProduct': '请选择具体产品',
            'order.enquiry.submit': '📤 提交咨询',
            'order.enquiry.cancel': '取消',
            'order.enquiry.contactAgent': '📞 联系代理',
            'order.enquiry.agentPhone': '代理电话: ',
            'order.enquiry.phoneRequired': '请填写手机号码',
            'order.enquiry.nameRequired': '请填写您的姓名',
            'order.enquiry.productRequired': '请选择产品',
            ...
            'about.subtitle': '健康生活的领导者',
            'about.empty.title': '内容正在筹备中',
            'about.empty.desc': '我们的团队正在准备精彩的内容。',
            'footer.terms': '使用条款',
            'footer.privacy': '隐私政策',
            'footer.support': '支持',
        ...
        en: {
            ...
            'order.deliveryDiff': 'Delivery address different',
            ...
            'order.success.msg': 'Thank you for submitting your details.',
            'order.success.ok': 'OK',
            'order.agent.unavailable': 'No agents available.',
            'order.selectProduct': 'Please select a product first',
            'order.fillRequired': 'Please fill in required fields',
            'order.enquiry.title': '📝 Product Enquiry',
            'order.enquiry.thanks': 'Thank you for your enquiry! Our agent will contact you shortly.',
            'order.enquiry.name': '👤 Your Name *',
            'order.enquiry.name.placeholder': 'Please enter your name',
            'order.enquiry.phone': '📱 WhatsApp Number *',
            'order.enquiry.phone.placeholder': 'e.g. 0123456789',
            'order.enquiry.productType': '📦 Product Type *',
            'order.enquiry.product': '🔧 Specific Product *',
            'order.enquiry.selectProductType': 'Select product type',
            'order.enquiry.selectProduct': 'Select product',
            'order.enquiry.submit': '📤 Submit Enquiry',
            'order.enquiry.cancel': 'Cancel',
            'order.enquiry.contactAgent': '📞 Contact Agent',
            'order.enquiry.agentPhone': 'Agent Phone: ',
            'order.enquiry.phoneRequired': 'Please enter your phone number',
            'order.enquiry.nameRequired': 'Please enter your name',
            'order.enquiry.productRequired': 'Please select a product',
            'locations.title': 'Our Locations',
            'locations.subtitle': 'Find a Coway experience centre near you',
            'locations.navigate': 'Navigate with Waze',
            'locations.noLocations': 'No locations available',
            'support.title': 'Customer Support',
            'support.subtitle': 'We are committed to providing you with the best service.',
            'support.feedback.title': 'Feedback',
            'support.feedback.subtitle': 'Tell us your questions or suggestions',
